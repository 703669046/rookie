...
<head>
    ...
    <!-- ace styles -->
    <link rel="stylesheet" href="<?php echo $ROOKIE_ROOT_DIR; ?>assets/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />
            ...
            <ul class="nav ace-nav">
                ...
                <li class=" dropdown-modal">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-user-photo" src="<?php echo $ROOKIE_ROOT_DIR; ?>assets/images/avatars/rookie.jpg"/>
            ...
            <li class="<?php echo $ACTIVE[1]; ?>">
                ...
                <ul class="submenu">
                    ...
                    <li class="<?php echo $ACTIVE[6]; ?>">
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/burteforce/bf_token.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            token防爆破?
                        </a>
            ...
            <li class="<?php echo $ACTIVE[7]; ?>">
                ...
                <ul class="submenu">
                    ...
                    <li class="<?php echo $ACTIVE[13]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/xss/xssblind/xss_blind.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            xss之盲打
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="<?php echo $ACTIVE[14]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/xss/xss_01.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            xss之过滤
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="<?php echo $ACTIVE[15]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/xss/xss_02.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                    ...
                    <li class="<?php echo $ACTIVE[16]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/xss/xss_03.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            xss之href输出
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="<?php echo $ACTIVE[17]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/xss/xss_04.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            xss之js输出
                        </a>
                        <b class="arrow"></b>
            ...
            <li class="<?php echo $ACTIVE[25]; ?>">
                ...
                <ul class="submenu">
                    ...
                    <li class="<?php echo $ACTIVE[26]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/csrf/csrf.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            概述
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="<?php echo $ACTIVE[27]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/csrf/csrfget/csrf_get_login.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            CSRF(get)
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="<?php echo $ACTIVE[28]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/csrf/csrfpost/csrf_post_login.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            CSRF(post)
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="<?php echo $ACTIVE[29]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/csrf/csrftoken/token_get_login.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            CSRF Token
                        </a>
                        <b class="arrow"></b>
        ...
        <li class="<?php echo $ACTIVE[50]; ?>">
            ...
            <ul class="submenu">
                ...
                <li class="<?php echo $ACTIVE[51]; ?>" >
                    <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/rce/rce.php">
                        <i class="menu-icon fa fa-caret-right"></i>
                        概述
                    </a>
                    <b class="arrow"></b>
                ...
                <li class="<?php echo $ACTIVE[52]; ?>" >
                    <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/rce/rce_ping.php">
                        <i class="menu-icon fa fa-caret-right"></i>
                        exec "ping"
                    </a>
                    <b class="arrow"></b>
                ...
                <li class="<?php echo $ACTIVE[53]; ?>" >
                    <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/rce/rce_eval.php">
                        <i class="menu-icon fa fa-caret-right"></i>
                        exec "evel"
                    </a>
                    <b class="arrow"></b>
        ...
        <li class="<?php echo $ACTIVE[55]; ?>">
            ...
            <ul class="submenu">
                ...
                <li class="<?php echo $ACTIVE[56]; ?>" >
                    <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/fileinclude/fileinclude.php">
                        <i class="menu-icon fa fa-caret-right"></i>
                        概述
                    </a>
                    <b class="arrow"></b>
                ...
                <li class="<?php echo $ACTIVE[57]; ?>" >
                    <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/fileinclude/fi_local.php">
                        <i class="menu-icon fa fa-caret-right"></i>
                ...
                <li class="<?php echo $ACTIVE[58]; ?>" >
                    <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/fileinclude/fi_remote.php"">
                        <i class="menu-icon fa fa-caret-right"></i>
        ...
        <li class="<?php echo $ACTIVE[60]; ?>">
                ...
                <ul class="submenu">
                    ...
                    <li class="<?php echo $ACTIVE[61]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/unsafedownload/unsafedownload.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            概述
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="<?php echo $ACTIVE[62]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/unsafedownload/down_nba.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            Unsafe Filedownload
                        </a>
                        <b class="arrow"></b>
            ...
            <li class="<?php echo $ACTIVE[73]; ?>">
                ...
                <ul class="submenu">
                    ...
                    <li class="<?php echo $ACTIVE[74]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/overpermission/op.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            概述
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="<?php echo $ACTIVE[75]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/overpermission/op1/op1_login.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            水平越权
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="<?php echo $ACTIVE[76]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/overpermission/op2/op2_login.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            垂直越权
                        </a>
                        <b class="arrow"></b>
            ...
            <li class="<?php echo $ACTIVE[80]; ?>">
                ...
                <ul class="submenu">
                    ...
                    <li class="<?php echo $ACTIVE[81]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/dir/dir.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            概述
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="<?php echo $ACTIVE[82]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/dir/dir_list.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            目录遍历
                        </a>
                        <b class="arrow"></b>
            ...
            <li class="<?php echo $ACTIVE[85]; ?>">
                ...
                <ul class="submenu">
                    ...
                    <li class="<?php echo $ACTIVE[86]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/infoleak/infoleak.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            概述
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="<?php echo $ACTIVE[87]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/infoleak/findabc.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            IcanseeyourABC
                        </a>
                        <b class="arrow"></b>
            ...
            <li class="<?php echo $ACTIVE[90]; ?>">
                ...
                <ul class="submenu">
                    ...
                    <li class="<?php echo $ACTIVE[91]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/unserilization/unserilization.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            概述
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="<?php echo $ACTIVE[92]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/unserilization/unser.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            PHP反序列化漏洞
                        </a>
                        <b class="arrow"></b>
            ...
            <li class="<?php echo $ACTIVE[95]; ?>">
                ...
                <ul class="submenu">
                    ...
                    <li class="<?php echo $ACTIVE[96]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/xxe/xxe.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            概述
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="<?php echo $ACTIVE[97]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/xxe/xxe_1.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            XXE漏洞
                        </a>
                        <b class="arrow"></b>
            ...
            <li class="<?php echo $ACTIVE[100]; ?>">
                ...
                <ul class="submenu">
                    ...
                    <li class="<?php echo $ACTIVE[101]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/urlredirect/unsafere.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            概述
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="<?php echo $ACTIVE[102]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/urlredirect/urlredirect.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            不安全的URL跳转
                        </a>
                        <b class="arrow"></b>
            ...
            <li class="<?php echo $ACTIVE[105]; ?>">
                ...
                <ul class="submenu">
                    ...
                    <li class="<?php echo $ACTIVE[106]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/ssrf/ssrf.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            概述
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="<?php echo $ACTIVE[107]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/ssrf/ssrf_curl.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            SSRF(curl)
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="<?php echo $ACTIVE[108]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>vul/ssrf/ssrf_fgc.php">
                            <i class="menu-icon fa fa-caret-right"></i>
            ...
            <li class="<?php echo $ACTIVE[120]; ?>">
                ...
                <ul class="submenu">
                    ...
                    <li class="<?php echo $ACTIVE[121]; ?>" >
                        <a href="<?php echo $ROOKIE_ROOT_DIR; ?>pkxss/index.php">
                            <i class="menu-icon fa fa-caret-right"></i>
                            XSS后台
                        </a>
                        <b class="arrow"></b>
